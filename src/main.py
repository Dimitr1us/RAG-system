...
def Research(task):
    ...
    Для лучшего решения внимательно изучи следующие примеры задач и их решений:
    """ + text + """
    Решай новую задачу самостоятельно, но учитывая подходы и стиль из примеров.
    Верни только чистый код функции без объяснений, markdown и блоков кода.
    """
